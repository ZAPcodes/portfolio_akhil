...
const experiences: WorkExperienceItem[] = [
  {
    title: "InnoTech Manipal",
    company: "InnoTech Manipal",
    role: "AI & Robotics Researcher",
    period: "April 2025 – Present",
    description: [
      "Researching in the field of Artificial Intelligence with focus on:"," Agentic AI, Multimodal Large Language Models (LLMs)","Transformers, Hybrid AI Architectures, and Retrieval-Augmented Generation (RAG)."
    ]
  },
  {
