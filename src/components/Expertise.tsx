...
const expertiseAreas = [
  ...
  },
  {
    icon: LineChart,
    title: 'Data Science',
    description: 'Leveraging statistical analysis, data visualization techniques and cutting-edge predictive modeling to uncover insights and forecast future trends.',
  },
  {
    icon: Server,
    title: 'Robotics',
